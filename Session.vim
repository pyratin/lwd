...
badd +207 js/server/schema/mutations/fns/sentencesGet.js
...
setlocal fen
silent! normal! zE
let s:l = 41 - ((18 * winheight(0) + 18) / 36)
...
setlocal fen
silent! normal! zE
let s:l = 201 - ((15 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
201
...
setlocal fen
silent! normal! zE
let s:l = 79 - ((4 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
79
...
setlocal fen
silent! normal! zE
let s:l = 71 - ((25 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
71
...
setlocal fen
silent! normal! zE
let s:l = 327 - ((32 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
327
