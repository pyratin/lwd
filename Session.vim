...
setlocal fen
silent! normal! zE
let s:l = 34 - ((30 * winheight(0) + 18) / 36)
...
setlocal fen
silent! normal! zE
let s:l = 182 - ((21 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
182
...
setlocal fen
silent! normal! zE
let s:l = 103 - ((0 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
103
...
setlocal fen
silent! normal! zE
let s:l = 419 - ((25 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
419
...
setlocal fen
silent! normal! zE
let s:l = 207 - ((27 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
207
...
setlocal fen
silent! normal! zE
let s:l = 40 - ((34 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
40
...
setlocal fen
silent! normal! zE
let s:l = 142 - ((33 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
142
