...
setlocal fen
silent! normal! zE
let s:l = 73 - ((27 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
73
...
setlocal fen
silent! normal! zE
let s:l = 121 - ((30 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
121
...
setlocal fen
silent! normal! zE
let s:l = 125 - ((11 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
125
...
setlocal fen
silent! normal! zE
let s:l = 39 - ((23 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
39
...
setlocal fen
silent! normal! zE
let s:l = 103 - ((30 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
103
...
setlocal fen
silent! normal! zE
let s:l = 158 - ((30 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
158
...
setlocal fen
silent! normal! zE
let s:l = 82 - ((30 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
82
