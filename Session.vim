...
badd +17 js/server/schema/mutations/fns/deckGet.js
...
badd +55 utils/webpack/webpackConfigBase.js
...
badd +1 js/client/Components/Home/index.js
badd +1 ~/Documents/Projects/lwd/js/client/mutations/MovieSearch.js
badd +1 ~/Documents/Projects/lwd/js/client/mutations/MovieCreate.js
argglobal
%argdel
set stal=2
edit package.json
...
setlocal fen
silent! normal! zE
let s:l = 52 - ((17 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
52
...
setlocal fen
silent! normal! zE
let s:l = 158 - ((18 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
158
...
setlocal fen
silent! normal! zE
let s:l = 67 - ((13 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
67
...
setlocal fen
silent! normal! zE
let s:l = 489 - ((15 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
489
...
setlocal fen
silent! normal! zE
let s:l = 83 - ((16 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
83
...
setlocal fen
silent! normal! zE
let s:l = 499 - ((10 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
499
...
setlocal fen
silent! normal! zE
let s:l = 562 - ((28 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
562
...
setlocal fen
silent! normal! zE
let s:l = 41 - ((33 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
41
...
setlocal fen
silent! normal! zE
let s:l = 179 - ((11 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
179
...
setlocal fen
silent! normal! zE
let s:l = 233 - ((25 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
233
normal! 013|
tabedit ~/Documents/Projects/lwd/js/client/mutations/MovieSearch.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal fen
silent! normal! zE
let s:l = 31 - ((0 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
31
normal! 0
tabedit ~/Documents/Projects/lwd/js/client/mutations/MovieCreate.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal fen
silent! normal! zE
let s:l = 136 - ((25 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
136
...
setlocal fen
silent! normal! zE
let s:l = 71 - ((32 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
71
...
setlocal fen
silent! normal! zE
let s:l = 186 - ((24 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
186
...
setlocal fen
silent! normal! zE
let s:l = 99 - ((19 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
99
...
setlocal fen
silent! normal! zE
let s:l = 30 - ((27 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
30
...
setlocal fen
silent! normal! zE
let s:l = 65 - ((0 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
65
