...
badd +1 ~/Documents/Projects/lwd/utils/datasets/fns/tmdb5000movieDecksCreate.js
argglobal
%argdel
set stal=2
edit package.json
...
19
normal! 036|
tabedit ~/Documents/Projects/lwd/utils/datasets/fns/tmdb5000movieDecksCreate.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal fen
silent! normal! zE
let s:l = 364 - ((35 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
364
...
setlocal fen
silent! normal! zE
let s:l = 141 - ((11 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
141
...
setlocal fen
silent! normal! zE
let s:l = 48 - ((4 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
48
...
setlocal fen
silent! normal! zE
let s:l = 165 - ((35 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
165
...
setlocal fen
silent! normal! zE
let s:l = 291 - ((35 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
291
...
setlocal fen
silent! normal! zE
let s:l = 26 - ((20 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
26
...
setlocal fen
silent! normal! zE
let s:l = 167 - ((0 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
167
