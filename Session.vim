...
badd +1 js/server/schema/mutations/fns/movieDataBasicGet.js
...
setlocal fen
silent! normal! zE
let s:l = 213 - ((29 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
213
...
setlocal fen
silent! normal! zE
let s:l = 40 - ((28 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
40
...
setlocal fen
silent! normal! zE
let s:l = 172 - ((17 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
172
...
setlocal fen
silent! normal! zE
let s:l = 484 - ((18 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
484
...
setlocal fen
silent! normal! zE
let s:l = 17 - ((11 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
17
...
setlocal fen
silent! normal! zE
let s:l = 195 - ((34 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
195
...
setlocal fen
silent! normal! zE
let s:l = 199 - ((16 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
199
...
setlocal fen
silent! normal! zE
let s:l = 575 - ((24 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
575
...
setlocal fen
silent! normal! zE
let s:l = 123 - ((0 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
123
...
setlocal fen
silent! normal! zE
let s:l = 376 - ((16 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
376
...
setlocal fen
silent! normal! zE
let s:l = 203 - ((28 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
203
...
setlocal fen
silent! normal! zE
let s:l = 121 - ((18 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
121
