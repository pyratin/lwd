...
badd +119 js/server/schema/mutations/fns/charactersMetaRoleAssignedGet.js
...
setlocal fen
silent! normal! zE
let s:l = 219 - ((33 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
219
...
setlocal fen
silent! normal! zE
let s:l = 135 - ((28 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
135
...
18
normal! 025|
tabedit js/client/mutations/MovieSearchMutation.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal fen
silent! normal! zE
let s:l = 203 - ((33 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
203
...
setlocal fen
silent! normal! zE
let s:l = 119 - ((27 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
119
...
setlocal fen
silent! normal! zE
let s:l = 52 - ((24 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
52
