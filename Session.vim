...
badd +0 js/server/schema/mutations/fns/charactersCulledByCategoryGet.js
argglobal
%argdel
set stal=2
edit package.json
...
90
normal! 0
tabedit js/server/schema/mutations/fns/deckSpoofableAssignedGet.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal fen
silent! normal! zE
let s:l = 61 - ((8 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
61
...
setlocal fen
silent! normal! zE
let s:l = 25 - ((17 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
25
...
setlocal fen
silent! normal! zE
let s:l = 159 - ((15 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
159
...
setlocal fen
silent! normal! zE
let s:l = 111 - ((31 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
111
...
setlocal fen
silent! normal! zE
let s:l = 120 - ((21 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
120
...
setlocal fen
silent! normal! zE
let s:l = 86 - ((25 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
86
...
setlocal fen
silent! normal! zE
let s:l = 383 - ((5 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
383
...
setlocal fen
silent! normal! zE
let s:l = 62 - ((9 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
62
...
setlocal fen
silent! normal! zE
let s:l = 40 - ((32 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
40
...
setlocal fen
silent! normal! zE
let s:l = 292 - ((21 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
292
