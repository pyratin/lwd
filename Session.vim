...
setlocal fen
silent! normal! zE
let s:l = 152 - ((15 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
152
...
setlocal fen
silent! normal! zE
let s:l = 90 - ((19 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
90
...
setlocal fen
silent! normal! zE
let s:l = 211 - ((18 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
211
...
setlocal fen
silent! normal! zE
let s:l = 772 - ((0 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
772
...
setlocal fen
silent! normal! zE
let s:l = 255 - ((24 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
255
...
setlocal fen
silent! normal! zE
let s:l = 730 - ((25 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
730
...
setlocal fen
silent! normal! zE
let s:l = 118 - ((24 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
118
