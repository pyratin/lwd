...
setlocal fen
silent! normal! zE
let s:l = 128 - ((26 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
128
...
setlocal fen
silent! normal! zE
let s:l = 472 - ((10 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
472
...
setlocal fen
silent! normal! zE
let s:l = 64 - ((14 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
64
...
setlocal fen
silent! normal! zE
let s:l = 236 - ((16 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
236
...
setlocal fen
silent! normal! zE
let s:l = 69 - ((18 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
69
...
setlocal fen
silent! normal! zE
let s:l = 90 - ((31 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
90
...
setlocal fen
silent! normal! zE
let s:l = 333 - ((25 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
333
...
setlocal fen
silent! normal! zE
let s:l = 657 - ((17 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
657
