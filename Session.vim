...
setlocal fen
silent! normal! zE
let s:l = 193 - ((33 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
193
...
setlocal fen
silent! normal! zE
let s:l = 132 - ((30 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
132
...
setlocal fen
silent! normal! zE
let s:l = 293 - ((15 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
293
...
setlocal fen
silent! normal! zE
let s:l = 208 - ((34 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
208
...
setlocal fen
silent! normal! zE
let s:l = 144 - ((33 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
144
...
setlocal fen
silent! normal! zE
let s:l = 68 - ((22 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
68
...
setlocal fen
silent! normal! zE
let s:l = 38 - ((16 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
38
