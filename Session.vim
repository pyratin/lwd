...
setlocal fen
silent! normal! zE
let s:l = 320 - ((14 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
320
...
setlocal fen
silent! normal! zE
let s:l = 39 - ((24 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
39
...
setlocal fen
silent! normal! zE
let s:l = 505 - ((10 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
505
...
setlocal fen
silent! normal! zE
let s:l = 99 - ((17 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
99
...
setlocal fen
silent! normal! zE
let s:l = 198 - ((24 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
198
