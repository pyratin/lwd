...
badd +368 utils/actor/create.js
...
setlocal fen
silent! normal! zE
let s:l = 325 - ((0 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
325
...
setlocal fen
silent! normal! zE
let s:l = 130 - ((15 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
130
...
setlocal fen
silent! normal! zE
let s:l = 66 - ((16 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
66
...
setlocal fen
silent! normal! zE
let s:l = 141 - ((19 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
141
...
setlocal fen
silent! normal! zE
let s:l = 195 - ((24 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
195
...
setlocal fen
silent! normal! zE
let s:l = 67 - ((25 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
67
...
setlocal fen
silent! normal! zE
let s:l = 263 - ((17 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
263
...
setlocal fen
silent! normal! zE
let s:l = 622 - ((29 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
622
...
setlocal fen
silent! normal! zE
let s:l = 285 - ((31 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
285
...
setlocal fen
silent! normal! zE
let s:l = 540 - ((24 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
540
...
setlocal fen
silent! normal! zE
let s:l = 136 - ((17 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
136
...
setlocal fen
silent! normal! zE
let s:l = 343 - ((23 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
343
