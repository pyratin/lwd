...
badd +0 utils/datasets/fns/jsonFromCsvGet.js
argglobal
%argdel
set stal=2
edit package.json
...
11
normal! 028|
tabedit utils/datasets/fns/jsonFromCsvGet.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal fen
silent! normal! zE
let s:l = 143 - ((32 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
143
...
setlocal fen
silent! normal! zE
let s:l = 70 - ((17 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
70
...
setlocal fen
silent! normal! zE
let s:l = 158 - ((34 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
158
...
setlocal fen
silent! normal! zE
let s:l = 65 - ((27 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
65
...
setlocal fen
silent! normal! zE
let s:l = 298 - ((16 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
298
...
setlocal fen
silent! normal! zE
let s:l = 295 - ((8 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
295
...
setlocal fen
silent! normal! zE
let s:l = 413 - ((32 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
413
