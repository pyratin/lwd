...
badd +1 js/server/fns/schemaUpdate.js
badd +1 utils/webpack/webpackConfigBase.js
badd +3 .babelrc
badd +1 js/client/index.js
badd +1 utils/webpack/webpackConfigDev.js
badd +0 js/client/styles.scss
badd +0 .stylelintrc.json
badd +0 js/client/Components/Viewer/index.js
argglobal
%argdel
set stal=2
edit package.json
...
setlocal fen
silent! normal! zE
let s:l = 63 - ((16 * winheight(0) + 17) / 34)
...
setlocal fen
silent! normal! zE
let s:l = 66 - ((16 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
66
...
setlocal fen
silent! normal! zE
let s:l = 161 - ((21 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
161
...
setlocal fen
silent! normal! zE
let s:l = 33 - ((20 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
33
normal! 025|
tabedit js/server/fns/schemaUpdate.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal fen
silent! normal! zE
let s:l = 62 - ((29 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
62
...
setlocal fen
silent! normal! zE
let s:l = 247 - ((0 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
247
...
setlocal fen
silent! normal! zE
let s:l = 504 - ((16 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
504
...
setlocal fen
silent! normal! zE
let s:l = 53 - ((28 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
53
