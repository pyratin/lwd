...
709
normal! zo
let s:l = 281 - ((35 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
281
...
setlocal fen
silent! normal! zE
let s:l = 70 - ((33 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
70
...
setlocal fen
silent! normal! zE
let s:l = 69 - ((29 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
69
...
setlocal fen
silent! normal! zE
let s:l = 189 - ((25 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
189
...
setlocal fen
silent! normal! zE
let s:l = 70 - ((28 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
70
...
setlocal fen
silent! normal! zE
let s:l = 804 - ((29 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
804
...
setlocal fen
silent! normal! zE
let s:l = 280 - ((25 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
280
...
setlocal fen
silent! normal! zE
let s:l = 530 - ((12 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
530
