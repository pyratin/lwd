...
setlocal fen
silent! normal! zE
let s:l = 135 - ((33 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
135
...
setlocal fen
silent! normal! zE
let s:l = 620 - ((13 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
620
...
setlocal fen
silent! normal! zE
let s:l = 56 - ((4 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
56
...
setlocal fen
silent! normal! zE
let s:l = 29 - ((27 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
29
...
setlocal fen
silent! normal! zE
let s:l = 806 - ((28 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
806
...
setlocal fen
silent! normal! zE
let s:l = 229 - ((24 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
229
...
setlocal fen
silent! normal! zE
let s:l = 88 - ((16 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
88
...
setlocal fen
silent! normal! zE
let s:l = 210 - ((15 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
210
...
setlocal fen
silent! normal! zE
let s:l = 712 - ((30 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
712
