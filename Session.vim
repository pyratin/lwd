...
setlocal fen
silent! normal! zE
let s:l = 137 - ((0 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
137
...
setlocal fen
silent! normal! zE
let s:l = 42 - ((29 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
42
...
setlocal fen
silent! normal! zE
let s:l = 107 - ((34 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
107
...
setlocal fen
silent! normal! zE
let s:l = 12 - ((3 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
12
...
setlocal fen
silent! normal! zE
let s:l = 110 - ((24 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
110
...
setlocal fen
silent! normal! zE
let s:l = 132 - ((1 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
132
...
setlocal fen
silent! normal! zE
let s:l = 151 - ((11 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
151
...
setlocal fen
silent! normal! zE
let s:l = 575 - ((21 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
575
...
setlocal fen
silent! normal! zE
let s:l = 126 - ((34 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
126
...
setlocal fen
silent! normal! zE
let s:l = 315 - ((32 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
315
...
setlocal fen
silent! normal! zE
let s:l = 242 - ((34 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
242
...
setlocal fen
silent! normal! zE
let s:l = 491 - ((29 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
491
