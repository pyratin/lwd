...
20
normal! 02|
tabedit js/server/fns/mediaOutputFolderInit.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal fen
silent! normal! zE
let s:l = 46 - ((10 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
46
...
setlocal fen
silent! normal! zE
let s:l = 135 - ((32 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
135
...
setlocal fen
silent! normal! zE
let s:l = 229 - ((32 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
229
...
setlocal fen
silent! normal! zE
let s:l = 620 - ((14 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
620
...
setlocal fen
silent! normal! zE
let s:l = 56 - ((3 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
56
...
setlocal fen
silent! normal! zE
let s:l = 138 - ((32 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
138
...
setlocal fen
silent! normal! zE
let s:l = 804 - ((28 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
804
...
setlocal fen
silent! normal! zE
let s:l = 280 - ((25 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
280
...
setlocal fen
silent! normal! zE
let s:l = 554 - ((33 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
554
...
setlocal fen
silent! normal! zE
let s:l = 237 - ((27 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
237
...
setlocal fen
silent! normal! zE
let s:l = 712 - ((31 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
712
