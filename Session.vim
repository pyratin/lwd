...
badd +0 js/server/schema/mutations/fns/actorGenderGet.js
argglobal
%argdel
set stal=2
edit package.json
...
setlocal fen
silent! normal! zE
let s:l = 101 - ((32 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
101
...
setlocal fen
silent! normal! zE
let s:l = 636 - ((30 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
636
...
setlocal fen
silent! normal! zE
let s:l = 210 - ((32 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
210
...
setlocal fen
silent! normal! zE
let s:l = 143 - ((35 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
143
...
setlocal fen
silent! normal! zE
let s:l = 232 - ((26 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
232
...
setlocal fen
silent! normal! zE
let s:l = 86 - ((27 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
86
...
setlocal fen
silent! normal! zE
let s:l = 432 - ((35 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
432
...
setlocal fen
silent! normal! zE
let s:l = 42 - ((33 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
42
...
setlocal fen
silent! normal! zE
let s:l = 36 - ((32 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
36
