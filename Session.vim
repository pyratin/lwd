...
setlocal fen
silent! normal! zE
let s:l = 102 - ((14 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
102
...
setlocal fen
silent! normal! zE
let s:l = 44 - ((19 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
44
...
setlocal fen
silent! normal! zE
let s:l = 585 - ((21 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
585
...
setlocal fen
silent! normal! zE
let s:l = 394 - ((28 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
394
...
setlocal fen
silent! normal! zE
let s:l = 423 - ((33 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
423
...
setlocal fen
silent! normal! zE
let s:l = 72 - ((25 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
72
