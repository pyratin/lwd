...
setlocal fen
silent! normal! zE
let s:l = 392 - ((21 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
392
...
setlocal fen
silent! normal! zE
let s:l = 63 - ((33 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
63
...
setlocal fen
silent! normal! zE
let s:l = 42 - ((31 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
42
...
setlocal fen
silent! normal! zE
let s:l = 176 - ((17 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
176
...
setlocal fen
silent! normal! zE
let s:l = 120 - ((18 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
120
...
setlocal fen
silent! normal! zE
let s:l = 295 - ((17 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
295
...
setlocal fen
silent! normal! zE
let s:l = 49 - ((15 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
49
...
setlocal fen
silent! normal! zE
let s:l = 585 - ((17 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
585
...
setlocal fen
silent! normal! zE
let s:l = 200 - ((18 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
200
...
setlocal fen
silent! normal! zE
let s:l = 302 - ((12 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
302
