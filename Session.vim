...
setlocal fen
silent! normal! zE
let s:l = 55 - ((18 * winheight(0) + 17) / 34)
...
setlocal fen
silent! normal! zE
let s:l = 220 - ((14 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
220
...
setlocal fen
silent! normal! zE
let s:l = 64 - ((23 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
64
...
setlocal fen
silent! normal! zE
let s:l = 46 - ((28 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
46
...
setlocal fen
silent! normal! zE
let s:l = 563 - ((23 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
563
...
setlocal fen
silent! normal! zE
let s:l = 95 - ((11 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
95
...
setlocal fen
silent! normal! zE
let s:l = 85 - ((30 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
85
...
setlocal fen
silent! normal! zE
let s:l = 43 - ((33 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
43
...
setlocal fen
silent! normal! zE
let s:l = 298 - ((8 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
298
...
setlocal fen
silent! normal! zE
let s:l = 179 - ((33 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
179
...
setlocal fen
silent! normal! zE
let s:l = 177 - ((30 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
177
