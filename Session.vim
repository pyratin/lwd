...
setlocal fen
silent! normal! zE
let s:l = 509 - ((16 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
509
...
setlocal fen
silent! normal! zE
let s:l = 85 - ((1 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
85
...
setlocal fen
silent! normal! zE
let s:l = 691 - ((25 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
691
...
setlocal fen
silent! normal! zE
let s:l = 162 - ((8 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
162
...
setlocal fen
silent! normal! zE
let s:l = 149 - ((13 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
149
...
setlocal fen
silent! normal! zE
let s:l = 84 - ((19 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
84
