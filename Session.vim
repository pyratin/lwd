...
badd +0 utils/actor/fns/actorImage.js
badd +0 utils/actor/fns/actor.js
badd +0 utils/actor/fns/set.js
argglobal
%argdel
set stal=2
edit package.json
...
setlocal fen
silent! normal! zE
let s:l = 70 - ((31 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
70
...
setlocal fen
silent! normal! zE
let s:l = 195 - ((23 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
195
...
setlocal fen
silent! normal! zE
let s:l = 69 - ((27 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
69
...
setlocal fen
silent! normal! zE
let s:l = 135 - ((29 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
135
...
setlocal fen
silent! normal! zE
let s:l = 189 - ((24 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
189
...
setlocal fen
silent! normal! zE
let s:l = 54 - ((30 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
54
...
setlocal fen
silent! normal! zE
let s:l = 70 - ((26 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
70
...
setlocal fen
silent! normal! zE
let s:l = 804 - ((27 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
804
...
setlocal fen
silent! normal! zE
let s:l = 307 - ((28 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
307
...
setlocal fen
silent! normal! zE
let s:l = 280 - ((24 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
280
...
setlocal fen
silent! normal! zE
let s:l = 530 - ((11 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
530
...
setlocal fen
silent! normal! zE
let s:l = 90 - ((20 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
90
...
setlocal fen
silent! normal! zE
let s:l = 29 - ((20 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
29
...
setlocal fen
silent! normal! zE
let s:l = 343 - ((18 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
343
...
setlocal fen
silent! normal! zE
let s:l = 72 - ((30 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
72
