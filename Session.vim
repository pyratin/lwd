...
badd +308 js/server/schema/mutations/fns/cardsGet.js
...
badd +499 js/server/schema/mutations/fns/cardsRenderedGet.js
badd +55 temp/imagemagickStreams.js
badd +1 js/server/schema/mutations/fns/splashRender.js
...
setlocal fen
silent! normal! zE
let s:l = 487 - ((20 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
487
...
setlocal fen
silent! normal! zE
let s:l = 21 - ((9 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
21
...
setlocal fen
silent! normal! zE
let s:l = 32 - ((29 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
32
...
setlocal fen
silent! normal! zE
let s:l = 438 - ((32 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
438
normal! 0
tabedit js/server/schema/mutations/fns/splashRender.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal fen
silent! normal! zE
let s:l = 172 - ((36 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
172
...
setlocal fen
silent! normal! zE
let s:l = 49 - ((31 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
49
...
setlocal fen
silent! normal! zE
let s:l = 808 - ((29 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
808
...
setlocal fen
silent! normal! zE
let s:l = 138 - ((20 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
138
...
setlocal fen
silent! normal! zE
let s:l = 585 - ((31 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
585
...
setlocal fen
silent! normal! zE
let s:l = 680 - ((32 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
680
