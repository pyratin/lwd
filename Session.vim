...
badd +109 js/server/schema/mutations/fns/deckActorImageIdsAssignedGet.js
badd +316 js/server/schema/mutations/fns/deckCulledByLimitGet.js
badd +483 js/server/schema/mutations/fns/deckRenderDetailsAssignedGet.js
...
badd +505 js/server/schema/mutations/fns/deckSpoofedGet.js
badd +24 js/server/schema/mutations/fns/spoofNamesGet.js
badd +1 js/server/schema/mutations/fns/spoofNames.js
badd +9 js/server/schema/mutations/fns/actorsGenderAssignedGet.js
badd +150 js/server/schema/mutations/fns/gifRenderedGet.js
...
setlocal fen
silent! normal! zE
let s:l = 13 - ((7 * winheight(0) + 17) / 34)
...
10
normal! 042|
tabedit utils/process/data/fns/actorsCreate.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal fen
silent! normal! zE
let s:l = 40 - ((11 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
40
normal! 012|
tabedit utils/process/data/fns/actorImagesCreate.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal fen
silent! normal! zE
let s:l = 252 - ((4 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
252
...
setlocal fen
silent! normal! zE
let s:l = 204 - ((16 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
204
...
setlocal fen
silent! normal! zE
let s:l = 89 - ((13 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
89
...
setlocal fen
silent! normal! zE
let s:l = 724 - ((15 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
724
