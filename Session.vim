...
badd +5 js/server/schema/mutations/fns/charactersActorGenderAssignedGet.js
badd +1 js/server/data/actor.js
badd +1 js/server/fns/mongoClientConnect.js
badd +1 js/server/data/index.js
badd +1 js/server/data/actorImage.js
badd +213 utils/actor/collectionInit.js
...
badd +438 js/server/schema/mutations/fns/cardsRenderedGet.js
badd +1 js/server/fns/variable.js
badd +1 js/server/data/movie.js
badd +1 js/server/schema/mutations/fns/movieWrite.js
badd +211 js/server/schema/mutations/fns/splashRenderedGet.js
badd +1 .gitignore
badd +1 js/server/schema/mutations/fns/base64TextCompositedGet.js
badd +1 ~/Documents/Projects/lwd/js/server/schema/mutations/fns/base64MiffStreamsConcatedGet.js
argglobal
%argdel
set stal=2
edit package.json
...
setlocal fen
silent! normal! zE
let s:l = 672 - ((18 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
672
...
setlocal fen
silent! normal! zE
let s:l = 101 - ((15 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
101
...
setlocal fen
silent! normal! zE
let s:l = 21 - ((0 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
21
...
setlocal fen
silent! normal! zE
let s:l = 107 - ((8 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
107
...
setlocal fen
silent! normal! zE
let s:l = 62 - ((13 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
62
...
setlocal fen
silent! normal! zE
let s:l = 87 - ((18 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
87
...
setlocal fen
silent! normal! zE
let s:l = 154 - ((9 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
154
...
setlocal fen
silent! normal! zE
let s:l = 22 - ((20 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
22
...
setlocal fen
silent! normal! zE
let s:l = 23 - ((11 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
23
...
setlocal fen
silent! normal! zE
let s:l = 221 - ((27 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
221
...
setlocal fen
silent! normal! zE
let s:l = 421 - ((35 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
421
normal! 0
tabedit ~/Documents/Projects/lwd/js/server/schema/mutations/fns/base64MiffStreamsConcatedGet.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal fen
silent! normal! zE
let s:l = 49 - ((31 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
49
...
setlocal fen
silent! normal! zE
let s:l = 289 - ((31 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
289
...
setlocal fen
silent! normal! zE
let s:l = 805 - ((23 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
805
...
setlocal fen
silent! normal! zE
let s:l = 255 - ((24 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
255
...
setlocal fen
silent! normal! zE
let s:l = 230 - ((17 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
230
...
setlocal fen
silent! normal! zE
let s:l = 553 - ((29 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
553
...
setlocal fen
silent! normal! zE
let s:l = 218 - ((19 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
218
...
setlocal fen
silent! normal! zE
let s:l = 317 - ((25 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
317
...
setlocal fen
silent! normal! zE
let s:l = 191 - ((19 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
191
...
setlocal fen
silent! normal! zE
let s:l = 29 - ((12 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
29
...
setlocal fen
silent! normal! zE
let s:l = 14 - ((6 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
14
...
setlocal fen
silent! normal! zE
let s:l = 428 - ((13 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
428
...
setlocal fen
silent! normal! zE
let s:l = 22 - ((0 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
22
