...
badd +532 utils/datasets/fns/tmdb5000moviesSemisCreate.js
...
badd +477 temp/datasets/json/tmdb_5000_movies.json
...
badd +100 js/server/schema/mutations/fns/wordsTokenizedGet.js
...
badd +0 js/server/schema/mutations/fns/NNPsUniqueGet.js
argglobal
%argdel
set stal=2
edit package.json
...
setlocal fen
silent! normal! zE
let s:l = 534 - ((18 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
534
...
setlocal fen
silent! normal! zE
let s:l = 277 - ((28 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
277
...
setlocal fen
silent! normal! zE
let s:l = 132 - ((20 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
132
...
setlocal fen
silent! normal! zE
let s:l = 282 - ((28 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
282
...
setlocal fen
silent! normal! zE
let s:l = 165 - ((31 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
165
...
setlocal fen
silent! normal! zE
let s:l = 941 - ((30 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
941
...
setlocal fen
silent! normal! zE
let s:l = 195 - ((30 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
195
...
setlocal fen
silent! normal! zE
let s:l = 29 - ((23 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
29
...
setlocal fen
silent! normal! zE
let s:l = 174 - ((16 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
174
...
setlocal fen
silent! normal! zE
let s:l = 45 - ((33 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
45
...
setlocal fen
silent! normal! zE
let s:l = 43 - ((13 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
43
...
setlocal fen
silent! normal! zE
let s:l = 72 - ((18 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
72
...
setlocal fen
silent! normal! zE
let s:l = 100 - ((16 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
100
