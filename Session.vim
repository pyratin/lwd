...
setlocal fen
silent! normal! zE
let s:l = 146 - ((14 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
146
...
setlocal fen
silent! normal! zE
let s:l = 60 - ((30 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
60
...
setlocal fen
silent! normal! zE
let s:l = 79 - ((31 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
79
...
setlocal fen
silent! normal! zE
let s:l = 301 - ((23 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
301
...
setlocal fen
silent! normal! zE
let s:l = 246 - ((17 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
246
...
setlocal fen
silent! normal! zE
let s:l = 864 - ((13 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
864
...
setlocal fen
silent! normal! zE
let s:l = 127 - ((0 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
127
