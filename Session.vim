...
badd +67 js/server/schema/mutations/fns/charactersGet.js
...
badd +76 js/server/schema/mutations/fns/deckGet.js
badd +1 js/server/data/deck.js
badd +1 utils/datasets/fns/tmdb5000movieDecksCreate.js
badd +88 js/server/schema/mutations/fns/deckActorImageIdsAssignedGet.js
badd +160 js/server/schema/mutations/fns/deckCulledByLimitGet.js
...
badd +232 js/server/schema/mutations/fns/movieDataBasicCastGet.js
badd +215 js/server/schema/mutations/fns/NNPCrossMatchGet.js
badd +42 js/server/schema/mutations/fns/cardsCharactersAssignedGet.js
badd +25 js/server/schema/mutations/fns/NNPCrossMatchesGet.js
badd +9 js/server/schema/mutations/fns/NNPsCrossMatchesGet.js
...
badd +34 js/server/schema/mutations/fns/spoofNamesGet.js
...
badd +110 js/server/schema/mutations/fns/deckAsyncDataAssignedGet.js
...
badd +285 js/server/schema/mutations/fns/deckCharactersSpoofedGet.js
badd +1 js/server/schema/mutations/fns/deckCardsSpoofedGet.js
badd +14 js/server/schema/mutations/fns/plotNNPsGet.js
badd +1 js/server/schema/mutations/fns/castNNPsGet.js
badd +0 js/server/schema/mutations/fns/deckSpoofableAssignedGet.js
badd +0 js/server/schema/mutations/fns/NNPBlacklistGet.js
argglobal
%argdel
set stal=2
edit package.json
...
setlocal fen
silent! normal! zE
let s:l = 131 - ((14 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
131
...
setlocal fen
silent! normal! zE
let s:l = 86 - ((19 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
86
...
setlocal fen
silent! normal! zE
let s:l = 93 - ((22 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
93
...
setlocal fen
silent! normal! zE
let s:l = 659 - ((22 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
659
...
setlocal fen
silent! normal! zE
let s:l = 34 - ((27 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
34
...
setlocal fen
silent! normal! zE
let s:l = 316 - ((23 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
316
...
setlocal fen
silent! normal! zE
let s:l = 63 - ((31 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
63
...
setlocal fen
silent! normal! zE
let s:l = 134 - ((0 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
134
...
setlocal fen
silent! normal! zE
let s:l = 165 - ((19 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
165
...
setlocal fen
silent! normal! zE
let s:l = 88 - ((9 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
88
...
setlocal fen
silent! normal! zE
let s:l = 303 - ((20 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
303
