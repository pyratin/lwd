...
badd +168 js/server/schema/mutations/fns/movieDataBasicGet.js
badd +211 js/server/schema/mutations/fns/charactersGet.js
...
badd +323 js/server/schema/mutations/fns/movieDataBasicCastGet.js
badd +124 js/server/schema/mutations/fns/movieDataBasicPlotGet.js
badd +143 js/server/schema/mutations/fns/NNPsGet.js
badd +31 js/server/schema/mutations/fns/spoofNamesGet.js
...
badd +603 js/server/schema/mutations/fns/charactersMetaRoleAssignedGet.js
...
badd +1 js/server/fns/movieIdRouteHandle.js
badd +1 utils/process/index.js
badd +1 js/server/fns/variable.js
badd +1 views/movies.ejs
badd +1 js/server/schema/mutations/fns/deckActorImageIdsAssignedGet.js
badd +0 js/server/schema/mutations/fns/charactersMetaAssignedGet.js
badd +0 js/server/schema/mutations/fns/charactersMetaStarringAssignedGet.js
...
setlocal fen
silent! normal! zE
let s:l = 125 - ((12 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
125
...
setlocal fen
silent! normal! zE
let s:l = 39 - ((24 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
39
...
setlocal fen
silent! normal! zE
let s:l = 103 - ((31 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
103
...
setlocal fen
silent! normal! zE
let s:l = 158 - ((32 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
158
...
setlocal fen
silent! normal! zE
let s:l = 298 - ((15 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
298
...
setlocal fen
silent! normal! zE
let s:l = 432 - ((17 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
432
...
setlocal fen
silent! normal! zE
let s:l = 79 - ((29 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
79
...
setlocal fen
silent! normal! zE
let s:l = 113 - ((17 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
113
...
setlocal fen
silent! normal! zE
let s:l = 646 - ((30 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
646
...
setlocal fen
silent! normal! zE
let s:l = 967 - ((12 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
967
...
setlocal fen
silent! normal! zE
let s:l = 245 - ((24 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
245
...
setlocal fen
silent! normal! zE
let s:l = 125 - ((10 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
125
...
setlocal fen
silent! normal! zE
let s:l = 236 - ((24 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
236
...
setlocal fen
silent! normal! zE
let s:l = 46 - ((33 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
46
...
setlocal fen
silent! normal! zE
let s:l = 31 - ((21 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
31
...
setlocal fen
silent! normal! zE
let s:l = 193 - ((5 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
193
