...
badd +22 js/server/fns/deckTitleRouteHandle.js
...
badd +4 js/server/fns/outputGifRouteHandle.js
argglobal
%argdel
set stal=2
edit package.json
...
setlocal fen
silent! normal! zE
let s:l = 24 - ((21 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
24
...
setlocal fen
silent! normal! zE
let s:l = 44 - ((28 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
44
...
setlocal fen
silent! normal! zE
let s:l = 35 - ((0 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
35
...
setlocal fen
silent! normal! zE
let s:l = 83 - ((24 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
83
...
setlocal fen
silent! normal! zE
let s:l = 83 - ((3 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
83
...
setlocal fen
silent! normal! zE
let s:l = 594 - ((33 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
594
...
setlocal fen
silent! normal! zE
let s:l = 72 - ((23 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
72
...
setlocal fen
silent! normal! zE
let s:l = 55 - ((16 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
55
...
setlocal fen
silent! normal! zE
let s:l = 61 - ((28 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
61
...
setlocal fen
silent! normal! zE
let s:l = 71 - ((11 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
71
...
setlocal fen
silent! normal! zE
let s:l = 244 - ((8 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
244
