...
setlocal fen
silent! normal! zE
let s:l = 67 - ((3 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
67
...
setlocal fen
silent! normal! zE
let s:l = 65 - ((30 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
65
...
setlocal fen
silent! normal! zE
let s:l = 90 - ((25 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
90
...
setlocal fen
silent! normal! zE
let s:l = 67 - ((27 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
67
...
setlocal fen
silent! normal! zE
let s:l = 622 - ((27 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
622
...
setlocal fen
silent! normal! zE
let s:l = 540 - ((22 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
540
