...
badd +23 js/server/schema/mutations/movieSearch/index.js
...
badd +21 js/server/fns/mongoClientConnect.js
badd +1 js/server/data/index.js
badd +1 js/server/data/actorImage.js
badd +672 utils/actor/collectionInit.js
...
badd +287 js/server/schema/mutations/fns/splashGet.js
badd +0 js/server/schema/mutations/fns/base64MiffStreamsConcatedGet.js
...
setlocal fen
silent! normal! zE
let s:l = 292 - ((12 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
292
...
setlocal fen
silent! normal! zE
let s:l = 109 - ((8 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
109
...
setlocal fen
silent! normal! zE
let s:l = 802 - ((20 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
802
...
setlocal fen
silent! normal! zE
let s:l = 310 - ((33 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
310
...
setlocal fen
silent! normal! zE
let s:l = 394 - ((24 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
394
...
setlocal fen
silent! normal! zE
let s:l = 252 - ((17 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
252
...
setlocal fen
silent! normal! zE
let s:l = 322 - ((30 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
322
