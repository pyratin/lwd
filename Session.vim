...
badd +3 js/server/schema/mutations/fns/wordsTokenizedGet.js
...
setlocal fen
silent! normal! zE
let s:l = 13 - ((4 * winheight(0) + 17) / 34)
...
setlocal fen
silent! normal! zE
let s:l = 104 - ((33 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
104
...
setlocal fen
silent! normal! zE
let s:l = 511 - ((26 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
511
...
setlocal fen
silent! normal! zE
let s:l = 528 - ((18 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
528
...
setlocal fen
silent! normal! zE
let s:l = 76 - ((33 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
76
...
setlocal fen
silent! normal! zE
let s:l = 16 - ((0 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
16
