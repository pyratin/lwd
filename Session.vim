...
setlocal fen
silent! normal! zE
let s:l = 99 - ((34 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
99
...
setlocal fen
silent! normal! zE
let s:l = 305 - ((25 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
305
...
setlocal fen
silent! normal! zE
let s:l = 49 - ((20 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
49
...
setlocal fen
silent! normal! zE
let s:l = 52 - ((35 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
52
...
setlocal fen
silent! normal! zE
let s:l = 39 - ((32 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
39
...
setlocal fen
silent! normal! zE
let s:l = 74 - ((25 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
74
...
setlocal fen
silent! normal! zE
let s:l = 653 - ((17 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
653
...
setlocal fen
silent! normal! zE
let s:l = 540 - ((25 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
540
...
setlocal fen
silent! normal! zE
let s:l = 343 - ((22 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
343
