...
badd +0 js/server/fns/movieIdRouteHandle.js
badd +0 utils/process/index.js
...
setlocal fen
silent! normal! zE
let s:l = 78 - ((33 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
78
...
setlocal fen
silent! normal! zE
let s:l = 41 - ((9 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
41
...
setlocal fen
silent! normal! zE
let s:l = 103 - ((31 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
103
...
setlocal fen
silent! normal! zE
let s:l = 49 - ((22 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
49
...
setlocal fen
silent! normal! zE
let s:l = 80 - ((20 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
80
...
setlocal fen
silent! normal! zE
let s:l = 246 - ((26 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
246
...
setlocal fen
silent! normal! zE
let s:l = 168 - ((17 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
168
...
setlocal fen
silent! normal! zE
let s:l = 125 - ((11 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
125
...
setlocal fen
silent! normal! zE
let s:l = 397 - ((31 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
397
...
setlocal fen
silent! normal! zE
let s:l = 236 - ((25 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
236
...
setlocal fen
silent! normal! zE
let s:l = 40 - ((32 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
40
...
setlocal fen
silent! normal! zE
let s:l = 193 - ((5 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
193
