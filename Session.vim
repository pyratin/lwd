...
badd +0 js/server/schema/mutations/fns/NNPChunkedBlacklistGet.js
argglobal
%argdel
set stal=2
edit package.json
...
setlocal fen
silent! normal! zE
let s:l = 70 - ((16 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
70
...
setlocal fen
silent! normal! zE
let s:l = 336 - ((14 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
336
...
setlocal fen
silent! normal! zE
let s:l = 281 - ((14 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
281
...
setlocal fen
silent! normal! zE
let s:l = 249 - ((28 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
249
...
setlocal fen
silent! normal! zE
let s:l = 412 - ((29 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
412
...
setlocal fen
silent! normal! zE
let s:l = 103 - ((19 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
103
