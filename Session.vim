...
setlocal fen
silent! normal! zE
let s:l = 672 - ((32 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
672
...
setlocal fen
silent! normal! zE
let s:l = 107 - ((14 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
107
...
setlocal fen
silent! normal! zE
let s:l = 62 - ((23 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
62
...
setlocal fen
silent! normal! zE
let s:l = 148 - ((31 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
148
...
setlocal fen
silent! normal! zE
let s:l = 428 - ((23 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
428
