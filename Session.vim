...
setlocal fen
silent! normal! zE
let s:l = 64 - ((19 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
64
...
setlocal fen
silent! normal! zE
let s:l = 138 - ((27 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
138
...
setlocal fen
silent! normal! zE
let s:l = 56 - ((27 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
56
...
setlocal fen
silent! normal! zE
let s:l = 47 - ((32 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
47
...
setlocal fen
silent! normal! zE
let s:l = 83 - ((4 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
83
...
setlocal fen
silent! normal! zE
let s:l = 293 - ((33 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
293
