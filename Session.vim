...
setlocal fen
silent! normal! zE
let s:l = 97 - ((23 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
97
...
setlocal fen
silent! normal! zE
let s:l = 313 - ((15 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
313
...
setlocal fen
silent! normal! zE
let s:l = 97 - ((0 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
97
...
setlocal fen
silent! normal! zE
let s:l = 128 - ((25 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
128
...
setlocal fen
silent! normal! zE
let s:l = 157 - ((30 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
157
...
setlocal fen
silent! normal! zE
let s:l = 265 - ((13 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
265
...
setlocal fen
silent! normal! zE
let s:l = 216 - ((16 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
216
...
setlocal fen
silent! normal! zE
let s:l = 88 - ((30 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
88
...
setlocal fen
silent! normal! zE
let s:l = 128 - ((17 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
128
