...
badd +0 js/server/schema/mutations/fns/charactersActorGenderAssignedGet.js
argglobal
%argdel
set stal=2
edit package.json
...
setlocal fen
silent! normal! zE
let s:l = 110 - ((28 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
110
...
setlocal fen
silent! normal! zE
let s:l = 262 - ((32 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
262
...
setlocal fen
silent! normal! zE
let s:l = 271 - ((16 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
271
...
setlocal fen
silent! normal! zE
let s:l = 143 - ((33 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
143
...
setlocal fen
silent! normal! zE
let s:l = 516 - ((3 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
516
...
setlocal fen
silent! normal! zE
let s:l = 95 - ((22 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
95
