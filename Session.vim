...
setlocal fen
silent! normal! zE
let s:l = 300 - ((16 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
300
...
setlocal fen
silent! normal! zE
let s:l = 40 - ((23 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
40
...
setlocal fen
silent! normal! zE
let s:l = 75 - ((7 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
75
...
setlocal fen
silent! normal! zE
let s:l = 184 - ((35 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
184
...
setlocal fen
silent! normal! zE
let s:l = 551 - ((28 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
551
...
setlocal fen
silent! normal! zE
let s:l = 220 - ((30 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
220
...
setlocal fen
silent! normal! zE
let s:l = 241 - ((19 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
241
...
setlocal fen
silent! normal! zE
let s:l = 65 - ((19 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
65
...
setlocal fen
silent! normal! zE
let s:l = 36 - ((24 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
36
