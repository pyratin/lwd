...
badd +1 js/server/fns/variables.js
badd +32 views/index.ejs
badd +1 js/server/schema/index.js
...
setlocal fen
silent! normal! zE
let s:l = 31 - ((27 * winheight(0) + 18) / 36)
...
setlocal fen
silent! normal! zE
let s:l = 49 - ((9 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
49
...
14
normal! 036|
tabedit js/server/schema/mutations/movieSearch.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal fen
silent! normal! zE
let s:l = 137 - ((31 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
137
...
setlocal fen
silent! normal! zE
let s:l = 155 - ((25 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
155
...
setlocal fen
silent! normal! zE
let s:l = 61 - ((25 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
61
...
3
normal! 014|
tabedit js/server/fns/variables.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
