...
134
normal! zo
let s:l = 387 - ((10 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
387
...
setlocal fen
silent! normal! zE
let s:l = 99 - ((35 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
99
...
setlocal fen
silent! normal! zE
let s:l = 146 - ((24 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
146
...
setlocal fen
silent! normal! zE
let s:l = 103 - ((25 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
103
...
setlocal fen
silent! normal! zE
let s:l = 67 - ((0 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
67
...
setlocal fen
silent! normal! zE
let s:l = 83 - ((35 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
83
...
setlocal fen
silent! normal! zE
let s:l = 75 - ((21 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
75
...
setlocal fen
silent! normal! zE
let s:l = 27 - ((24 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
27
...
setlocal fen
silent! normal! zE
let s:l = 622 - ((27 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
622
...
setlocal fen
silent! normal! zE
let s:l = 540 - ((23 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
540
