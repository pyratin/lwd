...
badd +3 .gitignore
badd +0 js/server/fns/mediaOutputFolderInit.js
argglobal
%argdel
set stal=2
edit package.json
...
setlocal fen
silent! normal! zE
let s:l = 125 - ((25 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
125
...
setlocal fen
silent! normal! zE
let s:l = 563 - ((10 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
563
...
setlocal fen
silent! normal! zE
let s:l = 237 - ((30 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
237
...
setlocal fen
silent! normal! zE
let s:l = 743 - ((24 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
743
