...
badd +5 js/server/schema/mutations/fns/deckCharactersGet.js
...
badd +0 js/server/schema/mutations/fns/charactersInstanceAssignedGet.js
argglobal
%argdel
set stal=2
edit package.json
...
setlocal fen
silent! normal! zE
let s:l = 36 - ((5 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
36
...
10
normal! 06|
tabedit js/server/schema/mutations/fns/deckCharactersGet.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal fen
silent! normal! zE
let s:l = 137 - ((35 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
137
normal! 0
tabedit js/server/schema/mutations/fns/charactersInstanceAssignedGet.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal fen
silent! normal! zE
let s:l = 111 - ((30 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
111
...
setlocal fen
silent! normal! zE
let s:l = 280 - ((35 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
280
...
setlocal fen
silent! normal! zE
let s:l = 246 - ((35 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
246
...
setlocal fen
silent! normal! zE
let s:l = 361 - ((22 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
361
...
setlocal fen
silent! normal! zE
let s:l = 142 - ((32 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
142
...
setlocal fen
silent! normal! zE
let s:l = 390 - ((32 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
390
...
setlocal fen
silent! normal! zE
let s:l = 33 - ((12 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
33
