...
badd +1 utils/webpack/webpackConfigBase.js
...
setlocal fen
silent! normal! zE
let s:l = 48 - ((21 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
48
...
setlocal fen
silent! normal! zE
let s:l = 148 - ((6 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
148
...
setlocal fen
silent! normal! zE
let s:l = 43 - ((30 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
43
...
setlocal fen
silent! normal! zE
let s:l = 120 - ((0 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
120
...
setlocal fen
silent! normal! zE
let s:l = 56 - ((33 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
56
...
setlocal fen
silent! normal! zE
let s:l = 54 - ((11 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
54
...
setlocal fen
silent! normal! zE
let s:l = 72 - ((26 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
72
...
setlocal fen
silent! normal! zE
let s:l = 45 - ((12 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
45
