...
badd +97 js/server/schema/mutations/fns/movieDataBasicGet.js
...
setlocal fen
silent! normal! zE
let s:l = 169 - ((5 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
169
...
setlocal fen
silent! normal! zE
let s:l = 161 - ((24 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
161
...
setlocal fen
silent! normal! zE
let s:l = 298 - ((18 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
298
...
setlocal fen
silent! normal! zE
let s:l = 390 - ((20 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
390
...
setlocal fen
silent! normal! zE
let s:l = 279 - ((25 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
279
...
setlocal fen
silent! normal! zE
let s:l = 673 - ((16 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
673
...
setlocal fen
silent! normal! zE
let s:l = 329 - ((23 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
329
...
setlocal fen
silent! normal! zE
let s:l = 15 - ((6 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
15
...
setlocal fen
silent! normal! zE
let s:l = 131 - ((16 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
131
