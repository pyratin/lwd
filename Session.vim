...
set shortmess=aoO
badd +102 js/server/index.js
badd +409 js/server/schema/index.js
badd +536 js/server/schema/mutations/movieCreate/index.js
badd +15 package.json
badd +1 js/client/index.js
badd +11 js/client/styles.scss
badd +45 js/client/Components/Viewer/index.js
badd +1 js/client/fns/index.js
badd +45 js/client/Components/Deck/index.js
badd +122 js/client/Components/Deck/DeckDetail.js
badd +1 js/client/Components/Deck/DeckNode.js
badd +35 js/server/data/deck.js
badd +203 js/server/data/index.js
badd +164 js/server/schema/mutations/fns/deckGet.js
badd +1 utils/datasets/fns/decksDone.json
badd +98 js/server/schema/mutations/fns/gifRenderedGet.js
badd +71 js/client/Components/Card/index.js
badd +50 utils/webpack/webpackConfigBase.js
...
badd +259 js/server/schema/mutations/fns/splashRenderedGet.js
badd +243 js/server/schema/mutations/fns/charactersMontageGet.js
...
badd +50 js/server/schema/query/deckConnectionGet.js
badd +55 js/server/schema/mutations/fns/deckCharactersSpoofedGet.js
badd +15 js/server/schema/mutations/fns/deckSpoofedGet.js
badd +17 js/server/schema/mutations/fns/spoofNamesGet.js
badd +159 utils/datasets/fns/tmdb5000movieDecksCreate.js
badd +24 .eslintrc.json
badd +1 js/client/Components/Carousel/index.js
badd +77 js/server/schema/mutations/fns/cardsGifyUrlAssignedGet.js
badd +1006 js/server/schema/mutations/fns/sentencesGet.js
badd +392 js/server/schema/mutations/fns/deckActorImageIdsAssignedGet.js
badd +26 js/client/Components/Loading/index.js
badd +1 js/server/schema/mutations/fns/charactersMetaAssignedGet.js
badd +137 js/server/schema/mutations/fns/charactersMetaRoleAssignedGet.js
badd +16 js/client/Components/Footer/index.js
badd +27 js/client/Components/Header/index.js
badd +231 js/client/Components/MovieSearch/index.js
badd +18 js/client/Components/MovieSearch/MovieSearchResultItem.js
badd +116 js/server/schema/mutations/movieSearch/index.js
badd +158 js/server/schema/mutations/fns/movieDataBasicGet.js
badd +193 js/server/schema/mutations/fns/movieDataBasicPlotGet.js
badd +123 js/server/schema/mutations/fns/NNPsGet.js
badd +29 js/server/schema/mutations/fns/plotNNPsGet.js
badd +153 js/server/schema/mutations/fns/charactersMetaStarringAssignedGet.js
badd +384 js/server/schema/mutations/fns/movieDataBasicCastGet.js
badd +67 js/server/schema/mutations/fns/deckSpoofableGet.js
badd +26 js/client/Components/Home/index.js
...
badd +64 views/movies.ejs
badd +116 js/server/fns/variable.js
badd +103 js/server/schema/mutations/fns/deckCardsSpoofedGet.js
badd +29 js/server/schema/mutations/fns/cardsCharactersAssignedGet.js
badd +40 js/server/schema/mutations/fns/fnDelayRun.js
badd +295 js/server/schema/mutations/fns/charactersGet.js
badd +148 js/server/schema/mutations/fns/NNPCrossMatchGet.js
badd +21 js/server/schema/mutations/fns/base64FilterAppliedGet.js
badd +52 js/server/schema/mutations/fns/base64MiffStreamsConcatedGet.js
badd +67 js/server/schema/mutations/fns/base64TextCompositedGet.js
badd +17 js/client/Components/Share/index.js
badd +60 js/server/fns/deckTitleRouteHandle.js
badd +8 js/server/schema/mutations/fns/VBGBlacklistGet.js
badd +23 js/server/schema/mutations/fns/movieWrite.js
badd +40 js/server/data/movie.js
badd +16 js/server/fns/outputGifRouteHandle.js
badd +1 js/server/data/genre.js
badd +1 js/client/Components/Share/ShareDownload.js
badd +1 js/client/Components/Share/ShareLink.js
badd +1 js/client/Components/Share/ShareLink/index.js
badd +33 js/server/schema/mutations/fns/sentencesTokenizedGet.js
argglobal
%argdel
set stal=2
edit package.json
...
setlocal fen
silent! normal! zE
let s:l = 159 - ((16 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
159
...
setlocal fen
silent! normal! zE
let s:l = 102 - ((13 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
102
...
setlocal fen
silent! normal! zE
let s:l = 45 - ((28 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
45
...
setlocal fen
silent! normal! zE
let s:l = 44 - ((18 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
44
...
setlocal fen
silent! normal! zE
let s:l = 257 - ((20 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
257
...
setlocal fen
silent! normal! zE
let s:l = 536 - ((0 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
536
...
setlocal fen
silent! normal! zE
let s:l = 71 - ((22 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
71
...
setlocal fen
silent! normal! zE
let s:l = 72 - ((24 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
72
...
setlocal fen
silent! normal! zE
let s:l = 51 - ((31 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
51
...
setlocal fen
silent! normal! zE
let s:l = 31 - ((24 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
31
...
setlocal fen
silent! normal! zE
let s:l = 43 - ((28 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
43
normal! 0
tabedit js/client/Components/Deck/DeckRefresh.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal fen
silent! normal! zE
let s:l = 163 - ((0 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
163
...
setlocal fen
silent! normal! zE
let s:l = 104 - ((17 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
104
...
setlocal fen
silent! normal! zE
let s:l = 61 - ((27 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
61
...
setlocal fen
silent! normal! zE
let s:l = 299 - ((33 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
299
...
13
normal! 012|
tabedit js/client/mutations/MovieCreate.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
