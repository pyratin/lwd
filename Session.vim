...
setlocal fen
silent! normal! zE
let s:l = 39 - ((17 * winheight(0) + 17) / 34)
...
setlocal fen
silent! normal! zE
let s:l = 73 - ((8 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
73
...
setlocal fen
silent! normal! zE
let s:l = 108 - ((18 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
108
...
setlocal fen
silent! normal! zE
let s:l = 522 - ((16 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
522
