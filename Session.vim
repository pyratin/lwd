...
setlocal fen
silent! normal! zE
let s:l = 52 - ((17 * winheight(0) + 18) / 36)
...
setlocal fen
silent! normal! zE
let s:l = 130 - ((31 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
130
...
setlocal fen
silent! normal! zE
let s:l = 207 - ((22 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
207
...
setlocal fen
silent! normal! zE
let s:l = 479 - ((22 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
479
...
setlocal fen
silent! normal! zE
let s:l = 245 - ((17 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
245
...
setlocal fen
silent! normal! zE
let s:l = 91 - ((17 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
91
...
setlocal fen
silent! normal! zE
let s:l = 316 - ((19 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
316
...
setlocal fen
silent! normal! zE
let s:l = 117 - ((0 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
117
...
setlocal fen
silent! normal! zE
let s:l = 62 - ((19 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
62
