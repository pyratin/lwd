...
badd +1 temp/ink/Components/InkConfirmInput.js
badd +0 temp/ink/Components/Viewer/index.js
badd +0 temp/ink/Components/OperationSelect/index.js
badd +0 temp/ink/Components/OperationRemove/index.js
badd +0 temp/ink/Components/OperationRemoveSelect/index.js
badd +0 js/server/data/index.js
badd +0 temp/ink/Components/CollectionSelect/index.js
argglobal
%argdel
set stal=2
edit package.json
...
setlocal fen
silent! normal! zE
let s:l = 11 - ((8 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
11
...
16
normal! 06|
tabedit temp/ink/Components/OperationRemoveSelect/index.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal fen
silent! normal! zE
let s:l = 60 - ((24 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
60
normal! 02|
tabedit temp/ink/Components/InkConfirmInput.js
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal fen
silent! normal! zE
let s:l = 640 - ((24 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
640
...
setlocal fen
silent! normal! zE
let s:l = 84 - ((12 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
84
...
setlocal fen
silent! normal! zE
let s:l = 235 - ((20 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
235
...
setlocal fen
silent! normal! zE
let s:l = 46 - ((15 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
46
...
setlocal fen
silent! normal! zE
let s:l = 231 - ((21 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
231
...
setlocal fen
silent! normal! zE
let s:l = 36 - ((19 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
36
...
setlocal fen
silent! normal! zE
let s:l = 119 - ((9 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
119
...
setlocal fen
silent! normal! zE
let s:l = 152 - ((19 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
152
...
setlocal fen
silent! normal! zE
let s:l = 78 - ((7 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
78
...
setlocal fen
silent! normal! zE
let s:l = 391 - ((12 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
391
...
setlocal fen
silent! normal! zE
let s:l = 245 - ((15 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
245
...
setlocal fen
silent! normal! zE
let s:l = 34 - ((15 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
34
...
setlocal fen
silent! normal! zE
let s:l = 160 - ((19 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
160
...
setlocal fen
silent! normal! zE
let s:l = 32 - ((22 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
32
...
setlocal fen
silent! normal! zE
let s:l = 181 - ((15 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
181
...
setlocal fen
silent! normal! zE
let s:l = 94 - ((21 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
94
...
setlocal fen
silent! normal! zE
let s:l = 84 - ((13 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
84
...
setlocal fen
silent! normal! zE
let s:l = 275 - ((11 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
275
...
setlocal fen
silent! normal! zE
let s:l = 541 - ((21 * winheight(0) + 12) / 25)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
541
