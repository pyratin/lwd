...
setlocal fen
silent! normal! zE
let s:l = 116 - ((24 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
116
...
setlocal fen
silent! normal! zE
let s:l = 158 - ((34 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
158
...
setlocal fen
silent! normal! zE
let s:l = 384 - ((16 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
384
...
setlocal fen
silent! normal! zE
let s:l = 41 - ((27 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
41
...
setlocal fen
silent! normal! zE
let s:l = 85 - ((17 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
85
...
setlocal fen
silent! normal! zE
let s:l = 55 - ((12 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
55
...
setlocal fen
silent! normal! zE
let s:l = 108 - ((9 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
108
