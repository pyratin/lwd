...
badd +1 utils/process/source/fns/download.js
...
setlocal fen
silent! normal! zE
let s:l = 40 - ((12 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
40
...
setlocal fen
silent! normal! zE
let s:l = 252 - ((4 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
252
...
setlocal fen
silent! normal! zE
let s:l = 204 - ((17 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
204
...
setlocal fen
silent! normal! zE
let s:l = 76 - ((26 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
76
...
setlocal fen
silent! normal! zE
let s:l = 178 - ((18 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
178
...
setlocal fen
silent! normal! zE
let s:l = 101 - ((28 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
101
...
setlocal fen
silent! normal! zE
let s:l = 89 - ((12 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
89
...
setlocal fen
silent! normal! zE
let s:l = 97 - ((29 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
97
...
setlocal fen
silent! normal! zE
let s:l = 320 - ((30 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
320
...
setlocal fen
silent! normal! zE
let s:l = 189 - ((11 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
189
