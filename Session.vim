...
setlocal fen
silent! normal! zE
let s:l = 894 - ((1 * winheight(0) + 17) / 34)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
894
...
setlocal fen
silent! normal! zE
let s:l = 139 - ((13 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
139
...
setlocal fen
silent! normal! zE
let s:l = 185 - ((35 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
185
...
setlocal fen
silent! normal! zE
let s:l = 212 - ((35 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
212
...
setlocal fen
silent! normal! zE
let s:l = 119 - ((17 * winheight(0) + 18) / 36)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
119
