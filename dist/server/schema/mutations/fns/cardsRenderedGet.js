...
var _cardsBase64AssignedGet = _interopRequireDefault(require("./cardsBase64AssignedGet"));
...
var cardsRenderedGet = function cardsRenderedGet(cards) {
  return cards.reduce(function (memo, card) {
    return memo.then(function (res) {
      return (0, _base64TextCompositedGet["default"])(card.base64, card.renderText, (0, _variable.outputResGet)(), 20, 10).then(function (result) {
...
var _default = /*#__PURE__*/function () {
  var _ref = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(_cards, db) {
    var cards, base64s;
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0, _cardsBase64AssignedGet["default"])(_cards, db);

          case 2:
            cards = _context.sent;
            cards = cardsFilterTypeAssignedGet(cards);
            _context.next = 6;
